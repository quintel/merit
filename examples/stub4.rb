  ...
  def self.stub
    ...
    merit_order.add(
      MustRunProducer.new(
        ...
        number_of_units: 341069.4785,
        availability: 0.97,
        fixed_costs: 933,
        load_profile_key: :buildings_chp,
        full_load_hours: 16907.68671
      )
    )
    ...
    merit_order.add(
      DispatchableProducer.new(
        ...
        marginal_costs: 139.7898305,
        effective_output_capacity: 66.96428571,
        number_of_units: 0.0,
        availability: 0.89,
    ...
    merit_order.add(
      User.new(
        key: :total_demand,
        total_consumption: 201985238481.21945
      )
    )
