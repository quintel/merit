...
# Mixins
require_relative 'merit/participants/finance'
...
require_relative 'merit/participants/variable_dispatchable_producer'
...
require_relative 'merit/flex/load_shifting'
