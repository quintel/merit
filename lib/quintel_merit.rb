...
#
# This code needs to have a different gem name. We have chosen quintel_merit. This file checks
# whether we are clashing with that existing gem and, if not loads the code.
